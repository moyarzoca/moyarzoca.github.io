...
(*Return 0*)
```
In the snipped we present the function `FormDegree`, that returns the degree of the object. And we have shown that the exterior derivative defined by Paillaco is nilpotent on any symbol `x`.
